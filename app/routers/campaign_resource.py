...
def update_campaign(campaign_id: int, request: CampaignInfluencerFinalizedRequest,
...
def update_campaign(campaign_id: int, content_shoot_date: date, db=Depends(db_manager.get_db)) -> GenericResponse:
    campaign_service = CampaignService(db)
...
def update_campaign(campaign_id: int, request: CampaignDraftApprovedRequest,
                    db=Depends(db_manager.get_db)) -> GenericResponse:
    campaign_service = CampaignService(db)
...
def update_campaign(campaign_id: int, request: CampaignContentPostRequest, db=Depends(db_manager.get_db)) -> GenericResponse:
    campaign_service = CampaignService(db)
...
def update_campaign(campaign_id: int, request: CampaignDay2BillingRequest,
                    db=Depends(db_manager.get_db)) -> GenericResponse:
    campaign_service = CampaignService(db)
...
def update_campaign(campaign_id: int, request: CampaignDay8BillingRequest,
                    db=Depends(db_manager.get_db)) -> GenericResponse:
    campaign_service = CampaignService(db)
...
def update_campaign(campaign_id: int, request: Optional[CampaignCompletionRequest] = None,
                    db=Depends(db_manager.get_db)) -> GenericResponse:
    campaign_service = CampaignService(db)
...
def update_campaign(campaign_id: int, db=Depends(db_manager.get_db)) -> GenericResponse:
    campaign_service = CampaignService(db)
...
def update_campaign(campaign_id: int, request: CampaignPendingDeliverables,
                    db=Depends(db_manager.get_db)) -> GenericResponse:
    campaign_service = CampaignService(db)
