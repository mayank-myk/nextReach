...
class InfluencerMetric(Base):
    ...
    insta_city_1 = Column(Enum(City), nullable=True)
    ...
    insta_consistency_score = Column(Integer, CheckConstraint('insta_consistency_score >= 0'), default=0)
    ...
    yt_consistency_score = Column(Integer, CheckConstraint('yt_consistency_score >= 0'), default=0)
    ...
    fb_consistency_score = Column(Integer, CheckConstraint('fb_consistency_score >= 0'), default=0)
