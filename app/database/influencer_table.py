...
class Influencer(Base):
    ...
    phone_number = Column(String(10), nullable=False, unique=False)  # Assuming it's a 10-digit phone number
    ...
    languages = Column(ARRAY(String), nullable=True)  # List of languages
    next_reach_score = Column(Integer, CheckConstraint('next_reach_score >= 0'), default=0)

    # Social profiles
    insta_username = Column(String(255), nullable=True, unique=False)
    insta_profile_link = Column(String(255), nullable=True)
    youtube_username = Column(String(255), nullable=True, unique=False)
    youtube_profile_link = Column(String(255), nullable=True)
    fb_username = Column(String(255), nullable=True, unique=False)
    ...
    deliverables = Column(ARRAY(String), nullable=False)
